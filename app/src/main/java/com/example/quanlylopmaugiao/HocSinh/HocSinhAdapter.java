...
public class HocSinhAdapter extends BaseAdapter {
    ...
    public HocSinhAdapter(int layout, Context context, ArrayList<HocSinh> ds) {
        Layout = layout;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        TextView tvTen, tvNamSinh, tvGioiTinh, tvMaLop;
        ImageView img_Anh;

        tvTen=view.findViewById(R.id.tv_TenHS);
        tvNamSinh=view.findViewById(R.id.tv_NamSinh);
        tvGioiTinh=view.findViewById(R.id.tv_GioiTinhHS);
        tvMaLop=view.findViewById(R.id.tv_MaLop);
        img_Anh=view.findViewById(R.id.image_HS);

        HocSinh gv=ds.get(i);
        tvTen.setText("Tên học sinh: "+gv.getTenHS());
        ...
        tvMaLop.setText("Mã lớp: "+gv.getMaLop());
